...
gulp.task('watch', function () {
	gulp.watch(['app/sections/**/*.pug', 'app/markup/**/*.pug'], ['html:build']);
	gulp.watch(['app/sections/**/*.less', 'app/elements/**/*.less', 'app/images/data-uri/**/*.svg', 'app/styles/**/*.less'], ['css:buildApp']);
	gulp.watch('app/styles/_BUILDER_LIBS.less', ['css:buildLib']);
	gulp.watch(['app/elements/**/*.js', 'app/sections/**/*.js', 'app/scripts/**/*.js'], ['js:buildApp']);
